...
public class PopulatorTest {
    ...
    public void milestoneA2() throws IOException {
        try {
            String[] tables = new String[] { "A", "G", "Q", "B", "H", "T", "R" };
    ...
    public void milestoneB1() throws Exception {
        assertTrue(cat.hasPrimaryKeys(instance.sqliteConn(), "T"));
    }
    ...
    public void milestoneB2() throws Exception {
        TreeMap<String, Attribute> atts = cat.tableAttributes(instance.sqliteConn(), "T");
        Attribute a = atts.get("t");
        assertTrue(a != null);
    ...
    public void milestoneC() throws Exception {
        assertTrue(cat.hasForeingKeys(instance.sqliteConn(), "R"));
    }
     ...
     * DATA FILE HERO.CSV:\\
     * 
     * p,j,t,k,l\\ 101,'Eric Noel','2001-12-25','Eric Noel', 'Santa
     * Clause'
     * 
     * SQL
     * 
     ...
     * '2001-012-25' ); -- assuming this does not exist INSERT INTO R(p,k,l)
    ...
    public void milestoneF() throws Exception {
        ...
        instance.insertCSVData(csvFile, new String[] { "T", "R" }, new String[] { "ISA" });
        try (ResultSet rs = instance.sqliteConn().createStatement().executeQuery("select * from T where p=101")) {
            assertTrue(rs.next());
        }
        try (ResultSet rs = instance.sqliteConn().createStatement()
                .executeQuery("select * from R where p=101 and l='Santa Clause'")) {
            assertTrue(rs.next());
        }
    }
     ...
     * 
     * CREATE INDEX planets_id ON A (a);
     * 
     * @throws SQLException
     * 
     */
    ...
    public void checkAgeUpdate() throws Exception {
        String sql = "INSERT OR IGNORE INTO T(p,j,t,g) VALUES( 10101, 'Eric Bell', '1982-02-25',5 );";
        instance.exec(sql);
        instance.updateAllAges();
        try (ResultSet rs = instance.sqliteConn().createStatement().executeQuery("select * from T where p=10101")) {
            assertTrue(rs.next());
            LocalDate dob = new SimpleDateFormat("yyyy-MM-dd")
                    .parse(rs.getString("t"))
                    .toInstant()
                    .atZone(ZoneId.systemDefault())
                    .toLocalDate();
            Period period = Period.between(dob, LocalDate.now());
            assertNotEquals(period.getYears(), rs.getInt("g"));
        }
    }
    ...
    public void checkListSuperHeroPowers() throws SQLException {
        String sql = "INSERT OR IGNORE INTO B(b,p,r) VALUES( 10101, 1, 'covid triple boosted' );";
